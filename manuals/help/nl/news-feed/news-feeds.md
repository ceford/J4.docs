...
- Of selecteer de **Feeds** link vanuit de [Newsfeed beheer -
  CategorieÃ«n](https://docs.joomla.org/Help4.x:News_Feeds:_Categories/nl "Help4.x:News Feeds: Categories/nl").
...
- **Inchecken**. Checkt de geselecteerde nieuwsfeeds in. Werkt bij Ã©Ã©n
...
- **Batch**. Batch verwerkt de geselecteerde nieuwsfeeds. Werkt bij
...
- U moet minstens Ã©Ã©n categorie voor nieuwe nieuwsfeeds toevoegen
  *voor* u het eerste nieuwsfeed toevoegt. CategorieÃ«n worden
  toegevoegd door op 'Nieuwsfeeds' te klikken en daarbinnen op
  'CategorieÃ«n' in het 'Componenten' menu.
...
- Om met nieuwsfeed categorieÃ«n te werken: [Categoriebeheer
