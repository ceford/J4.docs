...
Nieuwsfeed categorieÃ«n geven de mogelijkheid verschillende website
feeds te categoriseren voor een betere organisatie.
...
- **Bewerken**. Opent het scherm voor het bewerken van het geselecteerde
  categorie. Als er meer dan Ã©Ã©n categorie is geselecteerd (indien van
...
- **Inchecken**. Checkt de geselecteerde categorie in. Werkt bij Ã©Ã©n
  of meer categorie geselecteerd.

<!-- -->

- **Batch**. Batch verwerkt de geselecteerde categorie. Werkt bij Ã©Ã©n
...
- Om nieuwe nieuwsfeed categorieÃ«n toe te voegen: [Nieuwsfeed: Bewerk
