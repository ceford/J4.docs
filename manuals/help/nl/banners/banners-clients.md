...
bewerken of een nieuwe kunt aanmaken. Let op dat u minstens Ã©Ã©n
adverteerder en Ã©Ã©n advertentie-categorie moet hebben voordat u uw
eerste advertentie kunt toevoegen.

## Hoe toegang te krijgen

- Selecteer **Componenten â†’ Advertenties â†’ Adverteerders** vanuit
  het drop-down menu van het ***Joomla! Beheerpaneel***. U kunt ook de
...
- - **Inchecken**. Checkt de geselecteerde adverteerder in. Werkt bij
    Ã©Ã©n of meer adverteerder geselecteerd.
