...
Joomla! extensies kunnen geÃ¯nstalleerd worden via Ã©Ã©n van de vier
methodes, zoals hieronder aangegeven. Slechts Ã©Ã©n methode is nodig om
...
1.  Download een of meer archief bestanden (normaliter ".zip" of
    ...
    geÃ¯nstalleerd worden als Ã©Ã©n bestand (bijvoorbeeld, een component
    of module) terwijl andere extensies twee of meer bestanden kunnen
...
Indien geÃ¯nstalleerd, ziet u het 'Installeren vanaf web' tabblad, zoals
...
De upload begint automatisch. Let op de **Maximum upload size: â€ŽX.00
MB** in uw installatie. Indien u deze niet kunt verhogen, gebruik dan
...
3.  Geef In het *Installeren vanuit map* veld de map op de server aan
    waarnaar u uw bestanden en submappen van het pakket geÃ¼ploadet
    heeft.
...
- Evenzo kunnen, als u een component van derden deÃ¯nstalleert, deze
  modules en plugins niet meer gebruikt worden. Het is daarom aanbevolen
  deze afhankelijke modules en plugins ook te deÃ¯nstalleren.
...
- Installeer Joomla! extensies niet die gedownload zijn van warez sites
  want ze kunnen geÃ¯nfecteerd zijn met een virus of malware welke
...
- Een geÃ¯nstalleerde Template extensie zal worden toegevoegd aan de
  Site od Administrator lijst van het [Template
