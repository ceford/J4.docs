...
- **Bewerken**. Opent het scherm voor het bewerken van het geselecteerde
  tag. Als er meer dan ̩̩n tag is geselecteerd (indien van
  toepassing), wordt alleen het eerste tag geopend. Het bewerkingsscherm
  kan ook worden geopend door te klikken op de Naam van het tag.
...
- **Archiveren**. Verandert de status van ̩̩n van de geselecteerde tag
...
- **Inchecken**. Checkt de geselecteerde tag in. Werkt bij ̩̩n of meer
  tag geselecteerd.

<!-- -->

- **Batch**. Batch verwerkt de geselecteerde tag. Werkt bij ̩̩n of
