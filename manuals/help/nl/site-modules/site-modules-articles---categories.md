...
title: Site Modules: Articles - Categories
---
# Site Modules: Articles - Categories
## Beschrijving

De **Artikelen - CategorieÃ«n** module vertoont een lijst met
categorieÃ«n vanuit een hoofdcategorie. **Belangrijk:** Als de
hootdcategorie geen sub-categorieÃ«n heeft wordt de module niet getoond.
...
- **Beschrijvingen categorieÃ«n** (*Toon*/*Verberg*). Toon of verberg
  categorie beschrijvingen.
- **Aantal artikelen:** (*Toon*/*Verberg*). Toon of verberg het aantal
  artikelen.
- **SubcategorieÃ«n:** (*Toon*/*Verberg*). Toon of verberg
  subcategorieÃ«n.
- **\# Eerste subcategorieÃ«n:** (*Alle*/*1*/*2*/*3*/*4*/*5*/*6*/...).
  Selecteer hier het aantal eerste niveau subcategorieÃ«n dat getoond
...
werkelijke weergave is afhankelijk van het geÃ¯nstalleerde aanpaste
template en de template stijl van de Joomla! website.* Artikelen
categorieÃ«n module toont:
