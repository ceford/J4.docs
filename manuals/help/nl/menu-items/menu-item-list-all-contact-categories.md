...
title: Menu Item: List All Contact Categories
---
# Menu Item: List All Contact Categories
## Beschrijving

Het **Lijst van alle contactcategorieÃ«n** menu-item type wordt gebruikt
om een lijst met contactcategorieÃ«n te tonen binnen een categorie.

## Hoe toegang te krijgen

Om een nieuw lijst met alle contactcategorieÃ«n menu-item te maken:
...
- Klik op de Menu-itemtype selectie knop <img
  ...
  - Selecteer in de modale dialoog het 'Contactpersonen' item om een
    ...
    contactcategorieÃ«n** item.

Om een bestaande lijst van alle contactcategorieÃ«n menu-item te
bewerken:
...
- **Hoofdcategorie.** CategorieÃ«n die zich binnen deze categorie
...
- - *Alle* Alle subcategorieÃ«n onder de hoofdcategorie.
  - *\<#\>* Selecteer een aantal, 1 tot 5, om de diepte van de
    subcategorieÃ«n in te stellen.
