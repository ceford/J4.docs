...
hebben het laagste niveau binnen de hiÃ«rarchie van de inhoud. Een
artikel een onderdeel van Ã©Ã©n enkele categorie.
...
- **Selectievakje**. Vink dit vakje aan om Ã©Ã©n of meer artikelen te
...
1.  Selecteer Ã©Ã©n of meer artikelen uit de lijst door deze aan te
    vinken.
...
3.  Stel Ã©Ã©n of meer van de volgende waarden in:
    ...
    - Om de **Categorie** te wijzigen, selecteer een categorie uit de
      ...
      - Om de artikelen te **kopiÃ«ren** naar een andere categorie,
...
- Als Joomla geÃ¯nstalleerd is zonder voorbeeld inhoud, wordt
  automatisch de "Ongecategoriseerd" categorie aangemaakt.
