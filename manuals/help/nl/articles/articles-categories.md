...
Categoriebeheer wordt gebruikt om categorieÃ«n te vinden, toe te voegen
en te bewerken.

CategorieÃ«n worden gebruikt om artikelen te structureren en zo het
beheer en het tonen te vergemakkelijken. Ze kunnen in een boomstructuren
worden georganiseerd, zoals bestandsstructuren. Alle artikelen moet Ã³f
toegekend worden aan een hoofdcategorie of een onderliggende categorie.

## Hoe toegang te krijgen

**Controlepaneel **→** Site **→** ArtikelcategorieÃ«n**
...
- **Volgorde**. You can change the order of an category within a list as
  ...
  - Bij de filter-opties kan een limiet worden ingesteld op de lijst tot
    categorieÃ«n die gekoppeld worden aan bijvoorbeeld een taal.
...
- **Iconen**. Het aantal gepubliceerde, gedepubliceerde, gearchiveerde
  en categorieÃ«n in de prullenbak in iedere categorie. Klik op een
  nummer om een lijst met categorieÃ«n te krijgen.
- **Toegang**. Het
...
- **Associaties**. Toont de geassocieerde categorieÃ«n. Klik op de
...
- **Sortering**. Toont het huidige weergave volgorde veld. Er zijn 2
  ...
  - Klik op een kolomkop.De kolomkop wisselt tussen een oplopend en
    aflopend volgorde.
- **Te tonen aantal**. Toont het aantal categorieÃ«n in een lijst.
...
- **Acties**. Toont een lijst met acties voor geselecteerde
  categorieÃ«n. Vink een of meer categorieÃ«n aan om de lijst te
  activeren.
  - **Publiceren**. Maakt de geselecteerde categorieÃ«n beschikbaar voor
    de bezoekers van uw website.
  - **Depubliceren**. Maakt de geselecteerde categorieÃ«n niet
    beschikbaar voor de bezoekers van uw website.
  - **Archiveren**. Verandert de status van Ã©Ã©n van de geselecteerde
    categorieÃ«n om aan te geven dat ze worden gearchiveerd. [Meer
    leren.](https://docs.joomla.org/J4.x:How_to_Archive_an_Article/nl "J4.x:How to Archive an Article/nl")
  - **Inchecken**. Checkt de geselecteerde categorieÃ«n in.
  - **Prullenbak**. Verandert de status van de selecteerde categorieÃ«n
  ...
  - **Batch**. Batch verwerkt de geselecteerde categorieÃ«n.
- **Opnieuw opbouwen**. Ververst en stelt de categorieÃ«n tabel opnieuw
...
een groep geselecteerde categorieÃ«n die aangevinkt zijn.
...
**Hoe batchverwerking** voor een groep categorieÃ«n toepassen:

1.  Selecteer Ã©Ã©n of meer categorieÃ«n uit de lijst door deze aan te
    vinken.
...
| <span class="mw-selflink selflink">Artikelen: CategorieÃ«n</span>                                                                                                                      | Categoriebeheer wordt gebruikt om categorieÃ«n te vinden, toe te voegen en te bewerken.                                                                                                                                      |
