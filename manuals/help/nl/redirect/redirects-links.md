...
- **Archiveren**. Verandert de status van Ã©Ã©n van de geselecteerde
  items om aan te geven dat ze worden gearchiveerd. Gearchiveerde items
  kunnen terug naar de gepubliceerde of gedepubliceerde status gebracht
  worden door *Gearchiveerd* te selecteren in het Selecteer status
  filter en de status van de items te wijzigen naar Gepubliceerd of
  Gedepubliceerd.
...
geÃ¯nstalleerd in *.htaccess* uitvoeren, of welke naam uw Apache server
