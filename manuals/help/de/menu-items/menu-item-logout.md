...
Der MenÃ¼eintragstyp **Abmelden** bietet eine bequeme MÃ¶glichkeit, sich
abzumelden.

## Wie darauf zugreifen

Um einen neuen MenÃ¼eintrag **Abmelden** zu erstellen:
...
- Im Administrator-MenÃ¼ **MenÃ¼s **→** \[Name des MenÃ¼s\]** auswÃ¤hlen
  ...
  - Im modalen Fenster der Liste â€žBenutzerâ€œ anklicken und dann den
    Eintrag **Abmelden** wÃ¤hlen.

Zum Bearbeiten eines vorhandenen Logout-MenÃ¼punkts:
...
- **Abmeldeweiterleitungsseite**. Man kann die Standardseite verwenden
  ...
  Seite mit beschrÃ¤nktem Zugang angezeigt wird, sodass er auf eine
  Seite mit allgemeinem Zugang umgeleitet werden muss.
...
- Die **An- und Abmeldeweiterleitung** kann den Benutzer zu einer Seite
  ...
  bist angemeldet" mit grundsÃ¤tzlichen Informationen wie man sein
  Profil aktualisiert, es aufruft oder andere Informationen, um die
  Benutzerfreundlichkeit zu erhÃ¶hen.
