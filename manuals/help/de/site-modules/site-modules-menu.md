...
title: Site Modules: Menu
---
# Site Modules: Menu
## Beschreibung

Der Modultyp **MenÃ¼** dient dazu, ein MenÃ¼ an der gewÃ¼nschten
Position und auf den gewÃ¼nschten Webseiten zu positionieren. Eine
Website kann mehr als ein MenÃ¼ auf einer einzigen Seite und
unterschiedliche MenÃ¼s auf verschiedenen Webseiten anzeigen.
...
- **MenÃ¼ auswÃ¤hlen**. (*Haupt-MenÃ¼*/*Benutzer-MenÃ¼*/*usw.*) Ein
  MenÃ¼ aus der Liste aussuchen.
- **Basiseintrag**. (*Aktuell*/*Getting Started*/*Using Joomla!*/*Using
  Extensions*/*Components*/*Content Component*/usw.) Einen MenÃ¼eintrag
  auswÃ¤hlen, der immer als Basis fÃ¼r die MenÃ¼anzeige verwendet werden
  soll. Die Startebene muss auf die gleiche oder eine hÃ¶here Ebene als
  ...
  wird das Modul nur angezeigt, wenn der Ã¼bergeordnete MenÃ¼punkt aktiv
  ist.
- **Erste Ebene**. (*1*/*2*/*3*/*4*/*5*/*6*/*7*/usw.) Ebene, bei der die
  Darstellung des MenÃ¼s beginnen soll. Wenn die Start- und Endebene auf
  dieselbe Zahl gesetzt werden und die Option â€žUntermenÃ¼eintrÃ¤ge
  anzeigenâ€œ auf â€žAnzeigenâ€œ gesetzt ist, dann wird nur diese eine
  Ebene angezeigt.
- **Letzte Ebene**. (*Alle*/*1*/*2*/*3*/*4*/*5*/*6*/...) Ebene, bei der
  die Darstellung des MenÃ¼s beendet werden soll. Wenn "Alle" gewÃ¤hlt
  ist, werden alle Ebenen, abhÃ¤ngig von der Einstellung
  "UntermenÃ¼punkte anzeigen", eingeblendet.
- **UntermenÃ¼eintrÃ¤ge anzeigen**. (*Anzeigen*/*Verbergen*) Das MenÃ¼
  erweitern und seine UntermenÃ¼punkte immer anzeigen lassen.
