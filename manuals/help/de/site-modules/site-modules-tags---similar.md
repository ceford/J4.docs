...
title: Site Modules: Tags - Similar
---
# Site Modules: Tags - Similar
## Beschreibung

Der Modultyp **SchlagwÃ¶rter â€“ Ã„hnliche** zeigt Links zu anderen
EintrÃ¤gen mit Ã¤hnlichen SchlagwÃ¶rtern an. Die StÃ¤rke der
Ãœbereinstimmung kann angegeben werden.
...
- **Maximale Anzahl BeitrÃ¤ge:** (*1*/*2*/*3*/*4*/*5*/*6*/*7*/...).
  Maximale Anzahl der anzuzeigenden EintrÃ¤ge.
- **Suchtyp:** (*Alle*/*Irgendeiner*/*HÃ¤lfte*). Hier wird festgelegt,
  wie genau die SchlagwÃ¶rter eines Eintrags Ã¼bereinstimmen mÃ¼ssen.
  Alle â€“ erfordert, dass alle SchlagwÃ¶rter des angezeigten Objekts
  Ã¼bereinstimmen. Beliebig â€“ erfordert, dass mindestens ein
  Schlagwort Ã¼bereinstimmt. Halb â€“ erfordert, dass mindestens die
  HÃ¤lfte der SchlagwÃ¶rter Ã¼bereinstimmen (bei Dezimalzahlen wird
  aufgerundet).
