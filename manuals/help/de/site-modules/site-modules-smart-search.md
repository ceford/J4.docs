...
title: Site Modules: Smart Search
---
# Site Modules: Smart Search
## Beschreibung

Das Modul **Suchindex** ermÃ¶glicht eine erweiterte Suche auf der
Webseite.
...
- **Suchfilter:** (*Keine Filter*). Wenn ein Suchfilter ausgewÃ¤hlt
  wird, werden alle Ã¼ber dieses Modul durchgefÃ¼hrten Suchen auf die
  Verwendung des ausgewÃ¤hlten Filters beschrÃ¤nkt.
- **SuchvorschlÃ¤ge:** (*Anzeigen*/*Verbergen*). Legt fest, ob
  automatische SuchvorschlÃ¤ge angezeigt werden sollen oder nicht.
- **Erweiterte Suche:** (*VerknÃ¼pfung zur
  Komponente*/*Anzeigen*/*Verbergen*). Zum Umschalten, ob Benutzer die
  erweiterten Suchoptionen sehen sollen. Falls die Option auf
  â€žVerknÃ¼pfen zur Komponenteâ€œ gesetzt ist, wird ein Suchindex-Link
...
Ein Beispielformular fÃ¼r die Website-Suche ist unten abgebildet:
