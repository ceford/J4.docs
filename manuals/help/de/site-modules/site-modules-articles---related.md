...
title: Site Modules: Articles - Related
---
# Site Modules: Articles - Related
## Beschreibung

Der Modultyp **BeitrÃ¤ge - Verwandte** zeigt eine Liste von BeitrÃ¤gen
an, die mit dem aktuellen, vom Benutzer angesehenen Artikel verwandt
sind (z.B. ein Beitrags-Layout), ein Blog- oder Listen-Layout, bei dem
der Benutzer auf einen Beitrags-Link geklickt hat. BeitrÃ¤ge gelten als
miteinander verwandt, wenn sie mindestens ein SchlÃ¼sselwort in den
Metadateninformationen des Artikels gemeinsam haben.
Beitrags-SchlÃ¼sselwÃ¶rter werden im Abschnitt Metadaten-Informationen
der Seite [BeitrÃ¤ge:
...
Dieses Modul zeigt andere BeitrÃ¤ge, die mit dem aktuellen Beitrag
verwandt sind. Die Verbindung entstehen durch die SchlÃ¼sselwÃ¶rter.
Alle SchlÃ¼sselwÃ¶rter des aktuellen Beitrags werden gegen alle anderen
SchlÃ¼sselwÃ¶rter der verÃ¶ffentlichten BeitrÃ¤ge abgeglichen.

- **Datum anzeigen**. (*Anzeigen*/*Verbergen*). Zeigt das Datum an oder
  unterdrÃ¼ckt die Anzeige.
- **Max. BeitrÃ¤ge**. Die maximale Anzahl der angezeigten BeitrÃ¤ge
  (Standardwert ist 5).
...
- **ErklÃ¤render Text**. Dieses Modul zeigt weitere BeitrÃ¤ge an, die
  sich auf den gerade angezeigten Beitrag beziehen. Diese VerknÃ¼pfungen
  werden durch die SchlÃ¼sselwÃ¶rter hergestellt. Alle SchlÃ¼sselwÃ¶rter
  des aktuellen Beitrags werden mit allen SchlÃ¼sselwÃ¶rtern aller
  anderen verÃ¶ffentlichten BeitrÃ¤ge verglichen.  
  Beispielsweise kÃ¶nnte ein Beitrag Ã¼ber â€žPapageien zÃ¼chtenâ€œ und
  ein weiterer Ã¼ber â€žHandaufzucht von schwarzen Kakadusâ€œ vorhanden
  sein. Wenn beide BeitrÃ¤ge das Stichwort â€žPapageiâ€œ enthalten, wird
  im Modul â€žVerwandte BeitrÃ¤geâ€œ der Beitrag â€žPapageien
  zÃ¼chtenâ€œ angezeigt und umgekehrt.
