...
title: Site Modules: Random Image
---
# Site Modules: Random Image
## Beschreibung

Der Modultyp **Zufallsbild** zeigt ein zufÃ¤llig ausgewÃ¤hltes Bild aus
...
- **Breite (px):** Bildbreite â€“ erzwingt, dass alle Bilder mit dieser
  Breite, in Pixel, angezeigt werden.
- **HÃ¶he (px):** BildhÃ¶he â€“ erzwingt, dass alle Bilder mit dieser
  HÃ¶he, in Pixel, angezeigt werden.
...
Es wurden noch keine Tipps fÃ¼r das Modul Zufallsbild erstellt.
